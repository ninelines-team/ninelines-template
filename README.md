...
* [Работа с метатегами](docs/15_metatags.md)
  * [Базовые метатеги](docs/15_metatags.md#Базовые-метатеги)
    * [`charset`](docs/15_metatags.md#charset)
    * [`description`](docs/15_metatags.md#description)
    * [`keywords`](docs/15_metatags.md#keywords)
    * [`title`](docs/15_metatags.md#title)
    * [`viewport`](docs/15_metatags.md#viewport)
    * [`icon`](docs/15_metatags.md#icon)
    * [`manifest`](docs/15_metatags.md#manifest)
  * [Метатеги Apple](docs/15_metatags.md#Метатеги-apple)
    * [`apple-mobile-web-app-capable`](docs/15_metatags.md#apple-mobile-web-app-capable)
    * [`apple-mobile-web-app-status-bar-style`](docs/15_metatags.md#apple-mobile-web-app-status-bar-style)
    * [`apple-mobile-web-app-title`](docs/15_metatags.md#apple-mobile-web-app-title)
    * [`apple-touch-icon`](docs/15_metatags.md#apple-touch-icon)
    * [`apple-touch-icon-precomposed`](docs/15_metatags.md#apple-touch-icon-precomposed)
    * [`mask-icon`](docs/15_metatags.md#mask-icon)
  * [Метатеги Microsoft](docs/15_metatags.md#Метатеги-microsoft)
    * [`application-name`](docs/15_metatags.md#application-name)
    * [`msapplication-TileColor`](docs/15_metatags.md#msapplication-tilecolor)
    * [`msapplication-TileImage`](docs/15_metatags.md#msapplication-tileimage)
    * [`msapplication-square70x70logo`](docs/15_metatags.md#msapplication-square70x70logo)
    * [`msapplication-square150x150logo`](docs/15_metatags.md#msapplication-square150x150logo)
    * [`msapplication-wide310x150logo`](docs/15_metatags.md#msapplication-wide310x150logo)
    * [`msapplication-square310x310logo`](docs/15_metatags.md#msapplication-square310x310logo)
    * [`msapplication-notification`](docs/15_metatags.md#msapplication-notification)
    * [`X-UA-Compatible`](docs/15_metatags.md#x-ua-compatible)
  * [Метатеги Open Graph](docs/15_metatags.md#метатеги-open-graph)
    * [`og:url`](docs/15_metatags.md#og-url)
    * [`og:locale`](docs/15_metatags.md#og-locale)
    * [`og:title`](docs/15_metatags.md#og-title)
    * [`og:description`](docs/15_metatags.md#og-description)
    * [`og:image`](docs/15_metatags.md#og-image)
  * [Метатеги Twitter](docs/15_metatags.md#Метатеги-twitter)
    * [`twitter:card`](docs/15_metatags.md#twitter-card)
    * [`twitter:site`](docs/15_metatags.md#twitter-site)
    * [`twitter:creator`](docs/15_metatags.md#twitter-creator)
    * [`twitter:title`](docs/15_metatags.md#twitter-title)
    * [`twitter:description`](docs/15_metatags.md#twitter-description)
    * [`twitter:image`](docs/15_metatags.md#twitter-image)
